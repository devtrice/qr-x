...
export function Layout({ children, allSections = {} }) {
  ...
  switch (pathLayout(pathname)) {
    ...
    default:
      return (
        <DefaultLayout sections={allSections[pathname]}>
          {children}{' '}
        </DefaultLayout>
      )
  }
  ...
  return (
    <SectionProvider sections={sections}>
      <div className="h-full lg:ml-72 xl:ml-80">
        ...
        >
          <div className="contents shadow-sm lg:pointer-events-auto lg:block lg:w-72 lg:overflow-y-auto lg:border-zinc-900/10 lg:px-6 lg:pb-8 lg:pt-4 lg:dark:border-white/10 xl:w-80">
...
function DefaultLayout({ children, sections = [] }) {
  return (
    <SectionProvider sections={sections}>
      <Header />
      <main className="pt-6 md:px-0">{children}</main>
    </SectionProvider>
  )
}
