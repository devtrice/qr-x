    ...
    <div className="relative flex h-12 group">
      ...
      {autocompleteState.status === 'stalled' && (
        <div className="absolute inset-y-0 flex items-center right-3">
          <LoadingIcon className="w-5 h-5 animate-spin stroke-zinc-200 text-zinc-900 dark:stroke-zinc-800 dark:text-blue-500" />
        </div>
      )}
    </div>
  );
    ...
    >
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
          ...
          >
            <Dialog.Panel className="mx-auto transform-gpu overflow-hidden rounded-lg bg-zinc-50 shadow-xl ring-1 ring-zinc-900/7.5 dark:bg-blue-500dark:ring-zinc-800 sm:max-w-xl">
...
export function MobileSearch() {
  ...
  return (
    <div className="contents lg:hidden">
      <button
        type="button"
        className="flex items-center justify-center w-6 h-6 transition rounded-md hover:bg-zinc-900/5 ui-not-focus-visible:outline-none dark:hover:bg-white/5 lg:hidden"
        aria-label="Search ..."
        {...buttonProps}
      >
