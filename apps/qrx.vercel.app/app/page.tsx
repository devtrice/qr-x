      ...
      <section className='flex items-center justify-between lg:space-x-10 paging'>
        <div className='max-w-xl'>
          <h2 className='text-4xl font-bold text-white animate-duration-150 max-w-lg'>
            {['Integrates', 'in', 'popular', 'frontend', 'libraries', 'and', 'frameworks'].map((word, i) => (
              <Fragment key={word}>
          ...
          <p className='animate-in text-grey my-2 lg:my-4 animate-delay-1000'>
            QR-X integrates deeply with popular frontend frameworks and libraries, making it easy to generate full-fledged QR
            codes for your development experience
          </p>
        </div>
